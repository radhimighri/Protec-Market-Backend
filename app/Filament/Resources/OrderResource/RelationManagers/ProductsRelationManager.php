        ...
        return $form->schema([
            Grid::make(['default' => 0])->schema([
                ...
                TextInput::make('weight')
                    ...
                    ->placeholder(trans('crud.products.inputs.weight'))                    ->columnSpan([
                        'default' => 12,
                        'md' => 12,
                        'lg' => 12,
                    ]),
                    ...
                    ->rules(['required', 'numeric'])
                    ->numeric()
                    ->label(trans('crud.order_products.inputs.quantity'))
                    ->placeholder(trans('crud.order_products.inputs.quantity'))
                    ->columnSpan([
                        'default' => 12,
                        'md' => 12,
                        'lg' => 12,
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('name')->limit(20)->label(trans('crud.products.inputs.name')),
                ...
                Tables\Columns\TextColumn::make('quantity')->label(trans('crud.order_products.inputs.quantity')),
            ])
            ->filters([
