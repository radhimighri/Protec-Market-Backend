...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::create(['name' => 'list whishlists']);
        Permission::create(['name' => 'view whishlists']);
        Permission::create(['name' => 'create whishlists']);
        Permission::create(['name' => 'update whishlists']);
        Permission::create(['name' => 'delete whishlists']);
