<div>
    <div>
        ...
        <button class="button" wire:click="newCategorie">
            ...
            <div class="mt-5">
                <div>
                    <x-inputs.group class="w-full">
                        ...
                        >
                            <option value="null" disabled>Please select the Categorie</option>
            ...
            <thead class="text-gray-700">
                <tr>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.product_categories.inputs.categorie_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
            <tbody class="text-gray-600">
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="px-4 py-3 text-right" style="width: 70px;">
                        ...
                        >
                            @can('delete-any', App\Models\Categorie::class)
                            <button
                                class="button button-danger"
                                onclick="confirm('Are you sure?') || event.stopImmediatePropagation()"
                                wire:click="detach({{ $categorie->id }})"
                            >
                                <i
